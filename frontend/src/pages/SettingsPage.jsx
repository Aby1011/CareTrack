    ...
    <div className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8 animate-fade-in">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6 sm:mb-8">
          ...
          <button 
            onClick={handleSave}
            className="flex items-center gap-2 px-5 sm:px-6 py-2 bg-primary-500 hover:bg-primary-600 text-white rounded-xl font-bold transition-all shadow-lg shadow-primary-500/20 active:scale-95 text-sm"
          >
            {saveSuccess ? <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5" /> : <Save className="w-4 h-4 sm:w-5 sm:h-5" />}
