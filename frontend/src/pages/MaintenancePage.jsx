    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-sans">
      <div className="max-w-2xl w-full text-center space-y-12">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <p className="text-base sm:text-xl text-slate-500 font-medium max-w-lg mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
          <div className="bg-white p-5 sm:p-6 rounded-3xl border border-slate-100 shadow-sm flex items-start gap-4 transition-all hover:scale-[1.02]">
            <div className="p-3 bg-blue-50 rounded-2xl shrink-0">
              <Clock className="w-6 h-6 text-blue-600" />
            </div>
            <div>
              <h3 className="font-bold text-slate-800 text-sm sm:text-base">Estimated Time</h3>
              <p className="text-xs sm:text-sm text-slate-500 font-medium">Updates usually take 30-60 minutes.</p>
            </div>
          </div>
          <div className="bg-white p-5 sm:p-6 rounded-3xl border border-slate-100 shadow-sm flex items-start gap-4 transition-all hover:scale-[1.02]">
            ...
            <div>
              <h3 className="font-bold text-slate-800 text-sm sm:text-base">Data Safety</h3>
              <p className="text-xs sm:text-sm text-slate-500 font-medium">All your medical records are securely encrypted.</p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-4 sm:pt-8">
          <button 
            onClick={() => navigate('/')}
            className="px-6 sm:px-8 py-3.5 sm:py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-slate-800 transition-all shadow-xl flex items-center gap-2 mx-auto active:scale-95 text-sm sm:text-base"
          >
