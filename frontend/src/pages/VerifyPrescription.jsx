  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 sm:p-6 md:p-8 flex items-center justify-center">
      <div className="w-full max-w-lg">
        ...
        <div className="mb-6">
          <Link to="/" className="inline-flex items-center text-primary-600 hover:text-primary-700 transition-colors font-medium text-sm">
        ...
        {verificationResult?.valid ? (
          <div className="bg-white rounded-[2rem] p-6 sm:p-8 shadow-xl border border-green-100 relative overflow-hidden animate-fade-up">
            ...
            <div className="flex flex-col items-center text-center mb-6 sm:mb-8">
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-slate-800">Verified Prescription</h1>
              <p className="text-green-600 font-medium flex items-center justify-center gap-1 mt-1 sm:mt-2 text-sm">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="bg-slate-50 rounded-2xl p-4 sm:p-5 border border-slate-100">
                <h3 className="text-xs sm:text-sm font-semibold text-slate-500 uppercase tracking-wider mb-3">Prescription Details</h3>
                <div className="space-y-3">
                  <div>
                    <p className="text-xs text-slate-400">Medicine</p>
                    <p className="font-bold text-slate-800 text-base sm:text-lg">{verificationResult.data.medicineName}</p>
                  </div>
