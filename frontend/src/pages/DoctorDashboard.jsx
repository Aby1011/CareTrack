...
function DoctorDashboard({ user, onLogout }) {
  ...
  const Sidebar = () => (
    <>
      ...
      <div className={`w-64 bg-slate-900 text-white h-screen flex flex-col fixed left-0 top-0 z-50 transition-transform duration-300 ${
          ...
          {[
            ...
            <button
              ...
              onClick={() => { 
                ...
                if (item.id !== 'messages') setActiveChatPatient(null); 
        ...
        <div className="p-4 border-t border-slate-800">
          ...
          >
            ...
            <div className="min-w-0">
              <p className="font-medium text-sm group-hover:text-primary-400 transition-colors truncate">{user.name}</p>
              <p className="text-xs text-slate-400 truncate">{user.specialty}</p>
            </div>
          </div>
          <button
            onClick={onLogout}
            className="w-full flex items-center justify-center gap-2 py-2 px-4 bg-slate-800 hover:bg-slate-700 rounded-xl transition-colors text-slate-300 hover:text-white text-sm"
          >
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="lg:ml-64">
        <header className="bg-white border-b border-slate-200 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 sticky top-0 z-10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <button
              ...
              <div>
                ...
                <p className="text-slate-500 text-xs sm:text-sm">Welcome, Dr. {user.name.split(' ')[1] || user.name}</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <button 
      ...
      {showFollowUpModal && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm animate-fade-in p-4 overflow-y-auto">
          <div className="bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 w-full max-w-2xl shadow-2xl animate-scale-up border border-white/20 max-h-[90vh] overflow-y-auto my-auto">
            <div className="flex items-center justify-between mb-6 sm:mb-8">
              <div>
                <h3 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">
                  {selectedPatient?.followUpPlan ? 'Update Plan' : 'Create Follow-Up Plan'}
                </h3>
                <p className="text-slate-500 mt-1 text-xs sm:text-sm font-medium">Assign a structured care path for {selectedPatient?.name}</p>
              </div>
              <button
                onClick={() => setShowFollowUpModal(false)}
                className="text-slate-400 hover:text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-2xl p-2.5 sm:p-3 transition-all shrink-0"
              >
                <Plus className="w-5 h-5 sm:w-6 sm:h-6 rotate-45" />
              </button>
            </div>

            <form onSubmit={handleSavePlan} className="space-y-4 sm:space-y-6">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-4 sm:px-6 py-3.5 sm:py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 outline-none transition-all font-medium text-sm sm:text-base"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full px-4 sm:px-6 py-3.5 sm:py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 outline-none transition-all font-medium resize-none text-sm sm:text-base"
                />
              </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 sm:pr-6 py-3.5 sm:py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 outline-none transition-all font-medium text-sm sm:text-base"
                    />
                  </div>
                </div>
                <div className="space-y-1">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3 sm:gap-4 pt-4 sm:pt-6">
                <button
                  type="button"
                  onClick={() => setShowFollowUpModal(false)}
                  className="w-full sm:flex-1 px-6 sm:px-8 py-3.5 sm:py-4 border-2 border-slate-200 text-slate-600 rounded-2xl font-bold hover:bg-slate-50 hover:border-slate-300 transition-all active:scale-95"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="w-full sm:flex-1 px-6 sm:px-8 py-3.5 sm:py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/20 active:scale-95"
                >
