...
function Login({ onLogin }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4 sm:p-6 pt-16 sm:pt-6 relative">
      <Link
        to="/"
        className="absolute top-4 left-4 sm:top-6 sm:left-6 flex items-center gap-2 px-3 sm:px-4 py-2 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white rounded-xl transition-all duration-200 group z-50 text-xs sm:text-sm"
      >
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-primary-500 rounded-2xl mb-3 sm:mb-4 shadow-lg shadow-primary-500/30">
            <Heart className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
          </div>
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-1 sm:mb-2">{systemName}</h1>
          <p className="text-slate-400 text-sm sm:text-base">Remote Patient Follow-Up System</p>
        </div>

        {/* Login Card */}
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden">
          <div className="p-6 sm:p-8">
            <h2 className="text-xl sm:text-2xl font-semibold text-slate-800 mb-1 sm:mb-2 text-center">Welcome Back</h2>
            <p className="text-slate-500 text-xs sm:text-sm text-center mb-6">Sign in to access your dashboard</p>
