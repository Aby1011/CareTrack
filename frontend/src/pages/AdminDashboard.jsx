...
function AdminDashboard({ user, onLogout }) {
  ...
  const Sidebar = () => (
    <>
      ...
      <aside className={`fixed left-0 top-0 h-screen w-64 bg-slate-900 text-slate-300 p-6 flex flex-col z-50 transition-transform duration-300 ${
        ...
        <div className="pt-6 mt-6 border-t border-white/10">
          ...
          <button
            onClick={onLogout}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-red-500/10 hover:text-red-500 transition-all duration-200 text-sm font-semibold"
          >
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="lg:ml-64">
        <header className="bg-white border-b border-slate-200 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 sticky top-0 z-10 transition-all duration-300">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <button
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <p className="text-slate-500 text-xs sm:text-sm font-medium">Welcome back, {adminProfile.name} (Admin)</p>
            ...
            <div className="flex items-center gap-4">
              <button 
                ...
                className="relative p-2.5 hover:bg-slate-100 rounded-2xl transition-all active:scale-95 group"
              >
        ...
        <main className="p-4 sm:p-6 lg:p-8 pb-20 max-w-7xl mx-auto">
