    ...
    <div className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8 animate-fade-in">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-800">Personal Details</h1>
            <p className="text-slate-500 text-xs sm:text-sm">Full information for {user.name}</p>
          </div>
        </div>
