...
| :--- | :--- | :--- | :--- |
| **Admin** | `admin@system.com` | *Any password* | Dr. Sarah Johnson |
| **Doctor** | `dr.chen@system.com` | *Any password* | Dr. Michael Chen (Cardiology) |
| **Nurse** | `nurse.brown@system.com` | *Any password* | Nurse Jessica Brown |
| **Patient** | `john.smith.p101@email.com` | *Any password* | John Smith (Post-Cardiac Surgery) |
